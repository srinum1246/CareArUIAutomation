...
public class analystRolePages extends BaseTest {
    ...
    public void verifyAddNewExperience() throws ConfigurationException {
        ...
        wait(30);
        type(experiencesName_xpath,experienceName);
        wait(30);
        type(experiencesDescription_xpath,description);
    ...
    public void verifyEditExperience() throws ConfigurationException {
        ...
        type(experiencesSearchBox_xpath,ExpVal);
        wait(20);
...
//        closeActiveWindowMoveToActiveWindow();
        ...
        driverWaitClick(experiencesTab_xpath);
        type(experiencesSearchBox_xpath,updatedExpName);
        actionsClick(tableRow_xpath);
        editExperienceNameWithOutUpdate();
    ...
    public void verifyUsersSecondaryPhNoSorting() throws ConfigurationException {
        setApplPropFilePath("creatorRoleAdminUsers.properties");
        click(usersTab_xpath);
        verifyLongSortingOrder(usersTableSPhNumberAsc_xpath, usersTableSPhNumberDes_xpath, usersTableSPhNumber_xpath);
    }
    ...
    public void verifyAdmonistarationpage() throws ConfigurationException {
        ...
        {
            logPass("Administratation tab is displayed.");
        }
        else
        {
            logFail("Administration tab is not displayed.");
        }
    }
    ...
    public void verifyConnectorsPage() throws ConfigurationException {
        ...
        {
            logPass("Connectors tab is displayed.");
        }
        else
        {
            logFail("Connectors tab is not displayed.");
        }
    }
...
//    Analytics session Activity
    ...
    @Test
    public void verifyDeleteIndexForXmlSiteMap() throws ConfigurationException {
        setApplPropFilePath("creatorRoleAIservices.properties");
        navigateToAIServicesIntelligentSearchPage();
        indexEdit("Delete");
    }
    ...
    @Test
    public void verifyUpdateIndexForIndexFile() throws ConfigurationException {
        setApplPropFilePath("creatorRoleAIservices.properties");
        navigateToAIServicesIntelligentSearchPage();
    ...
    //aIServicesBtn_xpath
    @Test
    public void verifyPresenceOfAIServiceMenu() throws ConfigurationException, CsvValidationException, IOException {
        setApplPropFilePath("creatorRoleAIservices.properties");
        if(!isElementPresent(aIServicesBtn_xpath))
        {
            logPass("AIServices Menu is not present.");
        }
        else
        {
            logFail("AIServices Menu is present.");
        }
    }
